export default [
  ...
  `<div class="container">
      <h2 class="h1 special-heading text-center border-bottom"> 3 COLUMN WITH HEADER </h2>
      <div class="row mt-4">
          <div class="col-md-4">
              <div class="card border-0 bg-transparent">
  ...
  `<div class="container">
      <div class="row">
          <div class="col-md-4 py-2">
              <img style="width:100%" src="https://via.placeholder.com/600x600.png"/>
          </div>
          <div class="col-md-8">
              <div class="card border-0 bg-transparent">
                  <div class="card-body">
                      ...
                      <button class="btn btn-secondary">View More Info</button>
                  </div>
              </div>
          </div>
      </div>
          ...
          <div class="col-md-8">
              <div class="card border-0 bg-transparent">
                  <div class="card-body">
                      <div class="row">
                          <div class="col">
                              <h3 class="h5 card-title font-weight-bold">Job Title</h3>
                              </div>
                          <div class="col-auto text-right">
                              <p class="text-muted mb-0">
                                  Full Time | <small>$15 / hr</small>
                              </p>
                          </div>
                      </div>
                      <p class="card-text">
  ...
  `<div style="background-image:url('https://musicgoround.imgix.net/buyerweb/assets/_mgr/_img/background__bassplayer--gradient.jpg');">
      <div class="container py-5">
          <div class="row">
              <div class="col-md-5">
                  <h2 class="h1 special-heading"> Upcoming Event! </h2>
                  <h3 class="font-weight-bold text-primary">August 28th, 2020 @ 8PM</h3>
                  <p class="small text-muted font-italic">All ages are welcome!</p>
              </div>
              <div class="col-md-7">
                  <p class="text-white">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                  </p>
                  <button class="btn btn-outline-primary">View More Info</button>
              </div>
          </div>
      </div>
    </div>`,
